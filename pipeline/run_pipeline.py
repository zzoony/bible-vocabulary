...
def main():
    ...
    print("=" * 60)
    print(f"\nOutput directory: pipeline/output/{version}/")
    print(f"Main output: pipeline/output/{version}/bible_vocabulary.json")
    if args.with_sentences:
        print(f"With sentences: pipeline/output/{version}/bible_vocabulary_with_sentences.json")
